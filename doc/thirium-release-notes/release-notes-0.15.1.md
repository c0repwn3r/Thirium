Thirium Core version *0.15.1* is now available from:

  <https://download.thirium.org/thirium-0.15.1/>
...
A number of changes to the way Thirium Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 thiries per kB (0.00001 THI). This is to prepare for dropping the minimum transaction fee to 0.1 thiries per kB (0.0001 THI) in the next release.
