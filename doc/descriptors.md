# Support for Output Descriptors in Thirium Core

Since Thirium Core v0.17, there is support for Output Descriptors. This is a
...
on Thirium's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Thirium Core wallets, a convenience function `combo` is
