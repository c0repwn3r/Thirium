...
"""Verify that starting thirium with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start thirium with -h for help text")
        ...
        self.log.info("Start thirium with -version for version information")
        ...
        self.log.info("Start thiriumd with -fakearg to make sure it does not start")
