...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " thirium-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  thirium-tx [options] <hex-tx> [commands]  Update hex-encoded thirium transaction\n" +
            "or:     thirium-tx [options] -create [commands]   Create hex-encoded thirium transaction\n" +
            "\n";
