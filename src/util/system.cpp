...
const char * const BITCOIN_CONF_FILENAME = "thirium.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Thirium";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Thirium";
#else
    // Unix
    return pathRet / ".thirium";
#endif
#endif
}
